...
describe('infraestructura multilenguaje', () => {
  ...
  test('todas las claves literales usadas desde JavaScript existen en ambos catálogos', () => {
    const source = ['public/app-core.js', 'public/app.js', 'public/poser.js', 'public/asset-editor.js', 'public/dictation.js', 'public/distinctive-elements.js', 'public/character-profile.js', 'public/series-inspiration.js', 'public/budgets.js'].map(read).join('\n');
  ...
  test('los archivos visibles permanecen en UTF-8 sin mojibake', () => {
    const files = [
      ...
      'public/locales/es.js', 'public/locales/en.js', 'I18N_TASKS.md', 'public/series-inspiration.js', 'public/budgets.js', 'public/budget-model.js', 'lib/budget-pdf.js', 'BUDGETS.md'
    ];
