...
async function resolveFfmpegExecutable(configuredPath) {
  ...
  if (!configured) throw localizedServerError('ffmpegPathRequired', 'Configurá la ruta de ffmpeg en Configuración para armar el video.');
  ...
  throw localizedServerError('ffmpegPathMissing', `No encuentro ffmpeg en “${configured}”. Elegí la carpeta bin o el archivo ffmpeg.exe.`, { path: configured });
}
...
function runFfmpeg(bin, args) {
  return new Promise((resolve, reject) => {
    ...
    ps.on('error', (e) => reject(localizedServerError('ffmpegLaunchFailed', `No se pudo ejecutar ffmpeg: ${e.message}`, { error: e.message })));
    ps.on('close', (code) => code === 0 ? resolve(err) : reject(localizedServerError('ffmpegFailed', `ffmpeg falló (código ${code}): ${err.slice(-600)}`, { exitCode: code, error: err.slice(-600) })));
  });
}
...
const SERVER_ERROR_CODE_BY_MESSAGE = new Map([
  ['No se pudo leer la imagen para etiquetarla', 'labelImageReadFailed'],
  ['No se pudo leer la imagen para sobreimprimir el texto', 'overlayImageReadFailed'],
  ['Categoría de prompts no encontrada.', 'promptCategoryMissing'],
  ['Categoría de snippets no encontrada.', 'snippetCategoryMissing'],
  ['Categoría de vocabulario no encontrada.', 'vocabularyCategoryMissing'],
  ['El video de origen para editar o extender con Gemini Omni debe durar como máximo 10 segundos.', 'omniSourceTooLong'],
  ['Cada video usado como referencia de Gemini Omni debe durar como máximo 3 segundos.', 'omniReferenceTooLong'],
  ['Configurá la ruta de ffmpeg en Configuración para armar el video.', 'ffmpegPathRequired'],
  ['HeyGen OAuth no está conectado. Conectalo desde Configuración.', 'heygenNotConnected'],
  ['La sesión OAuth de HeyGen venció. Volvé a conectarla.', 'heygenSessionExpired'],
  ['El ZIP usa una compresión no compatible. Exportalo desde Manifestador.', 'zipCompression'],
  ['Ruta insegura dentro del ZIP.', 'zipUnsafePath'],
  ['ZIP incompleto.', 'zipIncomplete'],
  ['El ZIP contiene demasiados archivos.', 'zipTooManyFiles'],
  ['Ruta fuera de la zona permitida', 'assetOutsideZone'],
  ['El archivo debe ser una imagen PNG/JPG/WebP o un video MP4/MOV/WebM válido.', 'visualInvalid'],
  ['dataUrl inválido', 'dataUrlInvalid'],
  ['Los videos de referencia H3 no pueden superar 15 segundos en total.', 'h3VideoDuration'],
  ['Los audios de referencia H3 no pueden superar 15 segundos en total.', 'h3AudioDuration'],
  ['Gemini Omni 1.1 Flash todavía no admite audio subido como referencia.', 'omniAudioUnsupported'],
  ['Gemini Omni admite hasta 6 imágenes y 3 videos; máximo 9 referencias.', 'omniRefCount'],
  ['Inicio → Fin de Gemini Omni necesita exactamente dos imágenes.', 'omniFrames'],
  ['Una referencia supera el límite de 2 GB de Gemini Files.', 'geminiFileSize'],
  ['No pude comprobar la duración de un video de referencia de Gemini Omni.', 'omniProbeDuration'],
  ['Los videos de referencia de Seedance 2.5 deben medir entre 300 y 6000 px por lado y tener una proporción entre 0,4 y 2,5.', 'seedance25Dimensions'],
  ['Los videos de referencia de Seedance 2.5 deben tener entre 24 y 60 FPS.', 'seedance25Fps'],
  ['Los videos de referencia de Seedance 2.5 no pueden superar 30 segundos en total.', 'seedance25VideoDuration'],
  ['Los audios de referencia de Seedance 2.5 no pueden superar 30 segundos en total.', 'seedance25AudioDuration'],
  ['El prompt está vacío.', 'promptEmpty'],
  ['Los assets verificados de Seedance (asset://) solo sirven para video. Para imágenes usá fotos comunes.', 'verifiedAssetsVideoOnly'],
  ['Elegí un workflow de ComfyUI.', 'comfySelectWorkflow'],
  ['El workflow elegido ya no existe. Volvé a elegirlo.', 'comfyWorkflowGone'],
  ['Este workflow no tiene ningún nodo Tuzzi de salida (Imagen/Video/Audio) — Manifestador no podría recibir el resultado.', 'comfyNoOutputNodes'],
  ['ComfyUI terminó, pero ninguno de tus nodos Tuzzi de salida produjo un archivo (revisá el workflow en la interfaz de ComfyUI).', 'comfyEmptyOutput'],
  ['El texto que dirá el avatar está vacío.', 'avatarTextEmpty'],
  ['HeyGen admite hasta 5000 caracteres por video.', 'heygenTextLimit'],
  ['Elegí un personaje con código de avatar HeyGen.', 'heygenChooseAvatar'],
  ['HeyGen Imagen libre necesita una imagen local.', 'heygenLocalImage'],
  ['La referencia debe ser una imagen JPG, PNG o WebP.', 'referenceImageFormat'],
  ['HeyGen Imagen libre necesita el código de una voz de HeyGen.', 'heygenImageVoice'],
  ['HeyGen subió la imagen, pero no devolvió su asset_id.', 'heygenImageUploadId'],
  ['HeyGen aceptó la solicitud, pero no devolvió video_id.', 'heygenVideoId'],
  ['Inicio → Fin necesita exactamente dos imágenes: entrada y salida, en ese orden.', 'startEndFrames'],
  ['Gemini Omni no puede leer IDs privados de ModelArk. Elegí las fotos locales desde Assets.', 'omniPrivateRefs'],
  ['La conversación de Gemini Omni no coincide con una generación del historial. Volvé a elegir Editar o Extender desde el video original.', 'omniConversationMismatch'],
  ['Inicio → Fin de Seedance 2.5 necesita exactamente dos imágenes.', 'seedance25Frames'],
  ['Seedance 2.5 admite 30 imágenes, 10 videos y 10 audios; máximo 50 referencias en total.', 'seedance25RefCount'],
  ['MiniMax H3 no puede leer IDs privados de ModelArk. Elegí las fotos locales del personaje desde Assets.', 'h3PrivateRefs'],
  ['El modo Inicio → Fin de MiniMax H3 sólo acepta imágenes. Usá Referencias para video o audio.', 'h3FramesImageOnly'],
  ['Falta la generación MiniMax H3 original.', 'h3OriginalRequired'],
  ['No encuentro la generación MiniMax H3 original.', 'h3OriginalNotFound'],
  ['Sólo se pueden promover a 2K los videos H3 generados en 768P.', 'h3PromotionResolution'],
  ['Falta el MP4 768P original.', 'h3OriginalMp4'],
  ['La regeneración 2K no admite referencias remotas de ModelArk.', 'h3PromotionRemoteRefs'],
  ['El texto está vacío.', 'speechTextEmpty'],
  ['El texto sólo contiene etiquetas de expresión; escribí algo para locutar.', 'speechTagsOnly'],
  ['No pude calcular la duración para los subtítulos.', 'captionsDuration'],
  ['Falta el título de la ficha de vocabulario.', 'vocabularyTitleRequired'],
  ['Falta la categoría de la ficha de vocabulario.', 'vocabularyCategoryRequired'],
  ['Falta una imagen válida para la ficha de vocabulario.', 'vocabularyImageRequired'],
  ['Añadí al menos una palabra al vocabulario.', 'vocabularyWordsRequired'],
  ['La imagen del vocabulario no es válida.', 'vocabularyImageInvalid'],
  ['El vocabulario sólo admite imágenes PNG, JPG o WebP.', 'vocabularyImageFormat'],
  ['No encuentro la imagen elegida para el vocabulario.', 'vocabularyImageMissing'],
  ['El guion debe ser un objeto JSON.', 'scriptObjectRequired'],
  ['Este archivo es una cola de ComfyUI. Exportá “Guion para Manifestador” desde Controversy Tracker.', 'scriptComfyQueue'],
  ['El JSON no contiene una lista blocks válida.', 'scriptBlocksInvalid'],
  ['El contrato no contiene un proyecto válido.', 'contractProjectInvalid'],
  ['El contrato no contiene un identificador de guion.', 'contractScriptIdMissing'],
  ['El contrato no contiene requirements.', 'contractRequirementsMissing'],
  ['El guion para Manifestador no contiene bloques.', 'scriptBlocksEmpty'],
  ['Un mismo rol no puede declararse como más de un tipo de ficha.', 'scriptRoleDuplicate'],
  ['Faltan el tipo o el nombre de la categoría.', 'categoryTypeNameRequired'],
  ['Faltan la categoría actual o el nombre nuevo.', 'categoryRenameRequired'],
  ['Falta la categoría que querés borrar.', 'categoryDeleteRequired'],
  ['Falta el nombre de la categoría.', 'categoryNameRequired'],
  ['El snippet no tiene código.', 'snippetCodeRequired'],
  ['ZIP vacío o demasiado grande.', 'zipSizeInvalid'],
  ['El ZIP no contiene vocabulary.json.', 'vocabularyZipManifest'],
  ['vocabulary.json inválido.', 'vocabularyManifestInvalid'],
  ['Este ZIP no es un vocabulario de Manifestador.', 'vocabularyZipInvalid'],
  ['General es una categoría del sistema.', 'categoryGeneralReserved'],
  ['General es una categoría del sistema y no se puede borrar.', 'categoryGeneralDelete'],
  ['La imagen supera el límite de 20 MB para análisis con IA.', 'analysisImageSize'],
  ['Elegí una imagen PNG, JPG o WebP para analizar.', 'analysisImageFormat'],
  ['Subí una imagen antes de analizar el vocabulario.', 'vocabularyAnalyzeUpload'],
  ['El archivo supera el límite de 100 MB.', 'uploadSize'],
  ['El audio supera el límite de 100 MB.', 'audioUploadSize'],
  ['No se indicó ningún asset.', 'assetKeysRequired'],
  ['Demasiados assets en una sola operación.', 'assetBatchTooLarge'],
  ['Ese JSON no parece un guion exportado de Hookcast.', 'hookcastScriptInvalid'],
  ['Escribí un brief de la historia para generar el guion.', 'scriptBriefRequired'],
  ['Cada bloque debe conservar al menos un texto y, salvo que use Assets, un prompt visual.', 'blockContentRequired'],
  ['HeyGen subió el audio, pero no devolvió asset_id.', 'heygenAudioUploadId'],
  ['HeyGen aceptó el audio, pero no devolvió video_id.', 'heygenAudioVideoId'],
  ['No se pudieron preparar todos los planos HeyGen.', 'heygenShotsFailed'],
  ['Ese asset no es un audio.', 'assetNotAudio'],
  ['Elegí al menos una imagen o video para clasificar.', 'assetClassifyRequired'],
  ['Ese asset no se puede renombrar.', 'assetRenameUnsupported'],
  ['No se seleccionaron assets.', 'assetSelectionRequired'],
  ['Demasiados assets en una sola descarga.', 'assetDownloadTooLarge'],
  ['No se encontró ninguno de los archivos.', 'assetFilesMissing'],
  ['La selección contiene assets no eliminables.', 'assetDeleteUnsupported'],
  ['La variante HeyGen debe ser una imagen.', 'heygenVariantImage'],
  ['El ZIP no contiene character.json.', 'characterZipManifest'],
  ['Este ZIP no es un personaje de Manifestador.', 'characterZipInvalid'],
  ['Faltan modelo o hueso.', 'poserModelBoneRequired'],
  ['Faltan modelo o parte del cuerpo.', 'poserModelPartRequired'],
  ['Parte de cuerpo desconocida.', 'poserPartUnknown'],
  ['Configurá la ruta del workflow de ComfyUI en Configuración → ComfyUI.', 'comfyPathRequired'],
  ['ComfyUI no devolvió un prompt_id.', 'comfyPromptIdMissing'],
  ['ComfyUI no terminó la generación dentro del tiempo de espera.', 'comfyTimeout'],
  ['Falta la API key de HeyGen.', 'heygenKeyMissing'],
  ['HeyGen admite assets de hasta 32 MB.', 'heygenAssetSize'],
  ['HeyGen sigue procesando después de 20 minutos. El video_id quedó guardado en HeyGen.', 'heygenTimeout'],
  ['Falta la API key de Gemini (Google AI Studio). Cargala en Configuración.', 'geminiKeyRequired'],
  ['Falta la API key de Gemini (Google AI Studio). Cargala en Configuracion.', 'geminiKeyRequiredLegacy'],
  ['La IA no encontró etiquetas asociadas a los elementos de la imagen.', 'vocabularyNoLabels'],
  ['Falta la API key de BytePlus ModelArk (Ark). Cargala en Configuración.', 'arkKeyRequired'],
  ['Falta la API key de WaveSpeed para FireRed. Cargala en Configuración.', 'wavespeedKeyRequired'],
  ['FireRed Image Edit 1.1 necesita al menos una imagen de referencia.', 'fireRedReferenceRequired'],
  ['Falta la API key de OpenAI. Cargala en Configuración.', 'openaiKeyRequired'],
  ['Seedance necesita al menos el fotograma inicial en el modo Inicio → Fin.', 'seedanceStartRequired'],
  ['Seedance tardó más de 15 minutos; la tarea sigue en su consola pero acá la soltamos.', 'seedanceTimeout'],
  ['Falta la API key de Suno. Cargala en Configuración.', 'sunoKeyRequired'],
  ['En modo custom el estilo/género es obligatorio.', 'sunoStyleRequired'],
  ['En modo custom el título es obligatorio.', 'sunoTitleRequired'],
  ['Escribí una descripción de la canción.', 'sunoDescriptionRequired'],
  ['Suno tardó más de 8 minutos; la tarea sigue en tu proveedor pero acá la soltamos.', 'sunoTimeout'],
  ['Falta la API key de Google Cloud Translation (Configuración).', 'translationKeyRequired'],
  ['Google Cloud Translation no devolvió una traducción.', 'translationEmpty'],
  ['OpenAI no devolvió texto.', 'openaiTextEmpty'],
  ['OpenAI no devolvió el guion.', 'openaiScriptMissing'],
  ['OpenAI devolvió un guion vacío.', 'openaiScriptEmpty'],
  ['Falta la API key de ElevenLabs. Cargala en Configuración.', 'elevenlabsKeyRequired'],
  ['Elegí una voz (o ancla un personaje con voz asignada).', 'voiceRequired'],
  ['ElevenLabs no devolvió el audio generado.', 'elevenlabsAudioMissing'],
  ['Gemini Files no devolvió la URL de carga reanudable.', 'geminiUploadUrlMissing'],
  ['Gemini Files no devolvió el identificador del archivo.', 'geminiFileIdMissing'],
  ['Gemini tardó más de 10 minutos en procesar el video subido.', 'geminiUploadTimeout'],
  ['Gemini Omni terminó sin datos ni URI de video descargable.', 'omniVideoMissing'],
  ['Seedance 2.5 necesita un prompt.', 'seedance25PromptRequired'],
  ['Las referencias de Seedance 2.5 superan el límite directo de 64 MB por solicitud de ModelArk.', 'seedance25RequestSize'],
  ['MiniMax H3 necesita un prompt.', 'h3PromptRequired'],
  ['MiniMax H3 admite hasta 7000 caracteres por prompt.', 'h3PromptLimit'],
  ['MiniMax H3 necesita al menos una imagen en el modo Inicio → Fin.', 'h3StartRequired'],
  ['MiniMax H3 admite hasta 9 imágenes, 3 videos y 3 audios de referencia.', 'h3RefLimit'],
  ['MiniMax H3 exige acompañar el audio de referencia con al menos una imagen o video.', 'h3AudioCompanion'],
  ['MiniMax H3 tardó más de 30 minutos; la tarea puede seguir activa en su consola.', 'h3Timeout'],
  ['Las referencias de MiniMax H3 superan el máximo total de 64 MB. Reducí o comprimí los archivos.', 'h3RequestSize'],
  ['Falta la API key de MiniMax. Cargala en Configuración.', 'minimaxKeyRequired'],
  ['La IA no devolvió un resultado estructurado.', 'aiStructuredOutputMissing'],
  ['La IA devolvió un JSON de vocabulario inválido.', 'aiVocabularyJsonInvalid'],
  ['La generación falló sin detalle.', 'generationFailedNoDetail'],
  ['HeyGen devolvió un error.', 'heygenProviderError'],
  ['HeyGen no pudo generar el video.', 'heygenGenerationFailed'],
  ['Gemini no pudo procesar el video subido.', 'geminiUploadFailed'],
  ['Gemini Omni no pudo preparar el video generado.', 'omniOutputFailed'],
  ['ComfyUI falló al ejecutar el workflow.', 'comfyExecutionFailedEmpty'],
  ['MiniMax H3 terminó sin prompt enriquecido.', 'h3PromptEmpty'],
  ['MiniMax H3 terminó sin URL de video.', 'h3VideoUrlEmpty'],
  ['Cada video de referencia H3 debe durar entre 2 y 15 segundos.', 'h3RefDurationvideo'],
  ['Cada video de referencia de Seedance 2.5 debe durar entre 2 y 30 segundos.', 'seedance25RefDurationvideo'],
  ['Cada audio de referencia H3 debe durar entre 2 y 15 segundos.', 'h3RefDurationaudio'],
  ['Cada audio de referencia de Seedance 2.5 debe durar entre 2 y 30 segundos.', 'seedance25RefDurationaudio'],
  ['Editar necesita un video de origen o continuar una generación Omni desde el historial.', 'omniSourceRequiredEditing'],
  ['Editar necesita un video de origen o una generación Omni elegida desde el historial.', 'omniSourceHistoryEditing'],
  ['Extender necesita un video de origen o continuar una generación Omni desde el historial.', 'omniSourceRequiredExtension'],
  ['Extender necesita un video de origen o una generación Omni elegida desde el historial.', 'omniSourceHistoryExtension'],
  ...
  ['Serie no encontrada.', 'seriesNotFound'],
  ['Falta la API key de HeyGen en Configuración.', 'heygenApiKeyMissing'],
  ['Falta la API key de ElevenLabs en Configuración.', 'elevenLabsKeyMissing'],
