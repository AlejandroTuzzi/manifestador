...
export const IMAGE_MODELS = [
  ...
  ...['sunburst', 'flare'].map(variant => ({
    id: `gpt-image-2.5-${variant}`, name: `GPT Image 2.5 ${variant === 'sunburst' ? 'Sunburst' : 'Flare'}`,
    provider: 'openai', apiModel: `gpt-image-2.5-${variant}`, keyName: 'openai',
    aspectRatios: ['1:1', '2:3', '3:2', '3:4', '4:3', '4:5', '5:4', '9:16', '16:9', '21:9'],
    resolutions: ['1K', '2K', '4K'], maxRefs: 16, minRefs: 0, notes: ''
  })),
  {
    id: 'gpt-image-2',
    name: 'GPT Image 2',
  ...
  },
  {
    ...
    configModelKey: 'seedreamProModelId',
    ...
    maxRefs: 10,
    minRefs: 0,
    notes: 'ByteDance vía BytePlus ModelArk. Modelo principal de alta precisión: generación, edición localizada y fusión de hasta 10 referencias. Usa la misma key de Seedream Lite.'
  },
  {
    id: 'seedream-5-lite',
    ...
    configModelKey: 'seedreamModelId',
    keyName: 'ark',
  ...
  },
  {
    ...
    provider: 'qwen',
    apiModel: 'qwen-image-3.0-pro',
    keyName: 'qwen',
    aspectRatios: ['1:1', '2:3', '3:2', '3:4', '4:3', '4:5', '5:4', '9:16', '16:9', '21:9', '1:8', '8:1'],
    resolutions: ['1K', '2K'],
    maxRefs: 3,
    minRefs: 0,
    maxBatch: 6,
    nativeBatch: true,
    notes: 'Alibaba Model Studio. Generación y edición con hasta 3 referencias; texto preciso y composiciones complejas. Hasta 2K por área de píxeles.'
  },
  {
    id: 'firered-image-edit-1-1',
    name: 'FireRed Image Edit 1.1',
    provider: 'wavespeed',
    apiModel: 'wavespeed-ai/firered-image-v1.1/edit',
    configModelKey: 'fireRedModelId',
    keyName: 'wavespeed',
    editOnly: true,
    ...
    maxRefs: 3,
    minRefs: 1,
    notes: 'Edición mediante WaveSpeed. Exige 1–3 referencias; conserva identidad y combina personajes, vestuario y fondos. El filtro adicional de salida se solicita desactivado, sin eludir la política del proveedor.'
  }
];

export const VIDEO_MODELS = [
  ...['prime', 'standard'].map(variant => ({
    id: variant === 'prime' ? 'wan-3-prime' : 'wan-3',
    name: variant === 'prime' ? 'Wan 3.0 Prime' : 'Wan 3.0',
    provider: 'wan', apiModel: variant === 'prime' ? 'wan3.0-video-prime' : 'wan3.0-video', keyName: 'qwen',
    aspectRatios: ['16:9', '9:16', '21:9', '4:3', '3:4', '1:1', 'adaptive'],
    resolutions: ['480P', '720P', '1080P'], durations: [...Array.from({ length: 29 }, (_, i) => i + 2), -1],
    maxRefs: 20, minRefs: 0, refLimits: { reference: 20, frames: 2, first: 1 },
    mediaLimits: { image: 10, video: 5, audio: 5, total: 20 },
    supportsMultimediaReferences: true, audio: true, notes: ''
  })),
  {
    id: 'seedance-2-5',
    name: 'Seedance 2.5',
  ...
  },
  {
    ...
    maxRefs: 9,
    refLimits: { reference: 9, frames: 2, edit: 7, extend: 7 },
    mediaLimits: { image: 6, video: 3, audio: 0, total: 9 },
    minRefs: 0,
    audio: true,
    nativeAudio: true,
    supportsMultimediaReferences: true,
    ...
    notes: 'Google Gemini Omni 1.1 Flash. Genera video y audio nativos de 3 a 10 segundos, usa imágenes o hasta 3 clips cortos como referencia, admite inicio y fin, edición conversacional y extensiones encadenadas hasta 40 segundos. 1080p y 4K son reescalados; por ahora la API no admite audio subido como referencia.'
  },
  {
